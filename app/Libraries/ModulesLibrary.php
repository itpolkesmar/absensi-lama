...
//		shell_exec('php ../../../../../artisan dump-autoload');
	...
	*/
	public function generateFolder(){
		...
		{
			\File::makeDirectory($this->modulePath, 0777);
		}
		...
		\File::makeDirectory($this->modulePath . '/Controllers', 0777);
		//\File::makeDirectory($this->modulePath . '/Lang', 0755);
		\File::makeDirectory($this->modulePath . '/Models', 0777);
		\File::makeDirectory($this->modulePath . '/Migrations', 0777);
		\File::makeDirectory($this->modulePath . '/Views', 0777);

<section class="content-header">
    <h1>
        Buat Pegawaikhusus Baru<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Pegawaikhusus</a></li>
        <li class="active">Buat Pegawai Khusus Baru</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="box-body">
				<div class="form-group">
					...
					<div class="col-sm-7">
						{!! Form::text('tahun', date('Y'), array('class'=> 'form-control')) !!}
					</div>
				</div>
				<div class="form-group">
					{!! Form::label('id_pegawai', 'Pegawai:', array('class' => 'col-sm-3 control-label')) !!}
					<div class="col-sm-7">
						{!! \PegawaiModel::getSelect('id_pegawai') !!}
					</div>
				</div>
            </div>

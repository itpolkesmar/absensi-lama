    ...
    <div class="box box-primary">
        ...
        <div class="table-responsive">
            <div class="box-body no-padding">
                <table class="table table-striped table-hover table-condensed table-bordered" id='tabel'>
                    ...
                    <tr>
    					<td>{!!tanggal($harilibur->tanggal)!!}</td>
						<td>{!!$harilibur->keterangan!!}</td>
                        
                        @if(get_role()<4)
                        	<td>
		                        {!! ClaravelHelpers::btnEdit($harilibur->id) !!}
		                        &nbsp;
		                        {!! ClaravelHelpers::btnDelete($harilibur->id) !!}
                        	</td>
                    	@endif
                    </tr>
                    @endforeach
        ...
        <div class="box-footer clearfix">
          <div class="row">
            ...
            <div class="col-sm-6">
              <?php echo $hariliburs->appends(array('search' => Input::get('search')))->render(); ?>
            </div>
          </div>
        </div>
        {!! Form::close() !!}

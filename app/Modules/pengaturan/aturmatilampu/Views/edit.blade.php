<section class="content-header">
    <h1>
        Edit Aturmatilampu<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Aturmatilampu</a></li>
        <li class="active">Edit Aturmatilampu</li>
    </ol>
</section>
<section class="content">
  <div class="box box-primary">
    ...
    <div class="row">
      <div class="col-md-8">
        {!! Form::model($aturmatilampu, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
        {!! Form::hidden('id') !!}
        <div class="box-body">
            				<div class="form-group">
					{!! Form::label('id_unit', 'Unit:', array('class' => 'col-sm-3 control-label')) !!}
					<div class="col-sm-7">
						{!! Form::text('id_unit', null, array('class'=> 'form-control')) !!}
					</div>
				</div>
				<div class="form-group">

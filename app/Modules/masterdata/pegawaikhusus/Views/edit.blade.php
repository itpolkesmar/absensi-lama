<section class="content-header">
    <h1>
        Edit Pegawaikhusus<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Pegawaikhusus</a></li>
        <li class="active">Edit Pegawaikhusus</li>
    </ol>
</section>
<section class="content">
  <div class="box box-primary">
    ...
    <div class="row">
      <div class="col-md-8">
        {!! Form::model($pegawaikhusus, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
        {!! Form::hidden('id') !!}
        <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        {!! \PegawaiModel::getSelect('id_pegawai',$pegawaikhusus->id_pegawai) !!}
                    </div>
                </div>
            </div>
